...
return [
    ...
    'page.maps.title' => 'Maps',
    'page.maps.label' => 'Maps',
    ...
    'form.walker.actions.create.label' => 'Confirm my registration',
    ...
    'form.registration.notification.finish.body' => 'To be valid, registration must be paid',
